...
import (
	...
	"github.com/openshift/cluster-network-operator/pkg/controller/operconfig/fake"
...
func newTestDriver() *testDriver {
	...
	JustBeforeEach(func(ctx context.Context) {
		...
		t.fakeClient = fakeclient.NewFakeClient(t.apiServer, infrastructure, proxy, clusterConfigMap,
		...
		// Create in typed client for the statusManager) and CRClient (for controller)
